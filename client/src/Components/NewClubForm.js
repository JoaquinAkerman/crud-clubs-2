    ...
    <div className="new-club-form">
      ...
      <form action={serverNewClubBaseUrl} method="POST">
        <div className="form-group">
          ...
          <input type="text" id="name" name="name" placeholder="Club Atlético Independiente" />
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          <input type="text" id="tla" name="tla" />
        </div>
        ...
        <div className="form-group">
          ...
          <input type="text" id="clubColors" name="clubColors" />
        </div>
        <div className="form-group">
